...
async function runBasicDemo() {
    ...
    if (verificationResult.valid) {
        ...
        console.log("The presentation has been verified and contains the following attributes:");
        if (verificationResult.disclosedAttributes) {
            Object.entries(verificationResult.disclosedAttributes).forEach(([key, value]) => {
